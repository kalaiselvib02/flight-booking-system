<script>
    ...
    $: console.log({$selectedReturnOptions});
    $:console.log(selectedTripOption)



    function updateResults () {
        console.log("called upate")
        let dataArr = []
        if($selectedAirlineOptions.length) {
           $flightData.filter((el) => {
    ...
    .then(data => {
        return data.map((flight) => {
                    ...
                    // returnDateVal === $ticketSelection.selectedReturnDate
                        ...
                        console.log(flight.arrivalTimeVal - flight.departureTimeVal)
...
function setStorage() {
  ...
  localStorage.setItem("fromCity" , fcity)
}

$:$ticketSelection , setStorage()
...
<div class="search-results-wrapper">
    ...
    <div class="light-bg ticket-booking-wrapper">
        <TicketBooking bind:selectedTripOption btnText="Update Search" updateSearch={true} changeBtnStyle={true}/>
    </div>
